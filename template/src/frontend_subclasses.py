...
class paramTree():
    ...
    def createWidget(name, children):
        pw = parameterwidget()
        pw.setParameters(paramTree.create(name, children))
        return pw
...
class parameter(OrderedDict, object):
    ...
    def valueChanged(self):
        ...
        for fcn in self._setterCallbackList: fcn()
...
class DEADBEEFGUI(QtWidgets.QMainWindow):
    def __init__(self, cfg, app):
        super().__init__()
        self.cfg = cfg
        self.ui = frontendUI.Ui_DEADBEEF()
    ...
    def showDocu(self):
        ...
        tmpfile = op.join(gettempdir(),"DEADBEEFdocu.pdf")
        try:
